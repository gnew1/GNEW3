...
serviceInfo.labels("governance", process.env.ENVIRONMENT || "dev").set(1);
export const participationGauge = new Gauge({
    name: "governance_participation_ratio",
    help: "Participation ratio (for+abstain)/totalSupply for last proposal",
...
export function setParticipation(proposalId, ratio) {
